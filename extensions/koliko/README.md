...
[Koliko](https://github.com/angristan/koliko) is self-hostable usage analytics
for coding agents. Its Pi collector tracks sessions, agent runtime, models,
token usage, provider-reported cost, tool performance, compaction, goals, and

...
brief duplicate `Exploring` blocks. Settled `grep` searches append their match
count to the grouped search row, including `+` when the count is a lower bound
because the result hit a limit.
